...
func RunnerCadastroUnicoIndigenasExtremaPobreza() {

	runnerName := "Indigenas Extrema Pobreza"
	domain := "aplicacoes.cidadania.gov.br"
	url := "https://aplicacoes.cidadania.gov.br/vis/data3/v.php?q%5B%5D=oNOclsLerpibuKep3bV%2Bfmhh05Kv2rmg2a19ZW51ZXKmaX6JaV2Jk2CadmCNrMmTbXmUoNqmrLelkbbElM6cao22s5Wou5p135q5wZxokseU1rCYmLbAqanEe5vm%2FPq6oI7KgXzYofYK4rKinbtVn%2BZZwLerorgk2i3gon3fslShwKms3qaubqecudOY5J5TxunAl66xqZvsWbu9V3C4xZTdsaXMmxDOqrGYqfWpiA%3D%3D"
	unidadeMedida := "Familias Indigenas em Situação de Extrema Pobreza"
	fonte := "https://aplicacoes.cidadania.gov.br"
	file_path := "./data/sociais/indigenas_extrema_pobreza_cadastro_unico.json"
	fileNameOutputCSV := "./data/sociais/indigenas_extrema_pobreza_cadastro_unico.csv"
