...
func RunnerCadastroUnicoCiganosPobreza() {

	runnerName := "Ciganos Pobreza"
	domain := "aplicacoes.cidadania.gov.br"
	url := "https://aplicacoes.cidadania.gov.br/vis/data3/v.php?q%5B%5D=oNOclsLerpibuKep3bV%2Bfmll05Kv2rmg2a19ZW51ZXKmaX6JaV2Jk2CadmCNrMmTbX%2BUoNqmrLGglLbElM6cao3afmhsg5ub5ayyiZ2Ow9SYpXiZvufAmXeDqK%2FmtZOvpPAEzZzLsFOg5LSVqqmoWt6mbcGgoczC9hEA1sybsZlcuKSc657Hr1eWxdSW3Kanvu5toqtoeJvdmsDCqZx3JM3YppbM971v"
	unidadeMedida := "Familias Ciganas em Situação de Pobreza"
	fonte := "https://aplicacoes.cidadania.gov.br"
	file_path := "./data/sociais/ciganos_pobreza_cadastro_unico.json"
	fileNameOutputCSV := "./data/sociais/ciganos_pobreza_cadastro_unico.csv"
