...
func RunnerCadastroUnicoIndigenasPobreza() {

	runnerName := "Indigenas Pobreza"
	domain := "aplicacoes.cidadania.gov.br"
	url := "https://aplicacoes.cidadania.gov.br/vis/data3/v.php?q%5B%5D=oNOclsLerpibuKep3bV%2Bfmhg05Kv2rmg2a19ZW51ZXKmaX6JaV2Jk2CadmCNrMmTbXmUoNqmrLelkbbElM6cao3afmhsg5ub5ayyiZ2Ow9SYpXiZvufAmXeDqK%2FmtZOvpPAEzZzLsFOm6bH36a%2BaqNqsbbOkTcrKp9%2Be9gQ%2B8KNcrJpa6aivwJynuIGc2LCWz%2BTBla9oo6mZfK6ymKDL06KKAM3L5LCjuLhw"
	unidadeMedida := "Familias Indigenas em Situação de Pobreza"
	fonte := "https://aplicacoes.cidadania.gov.br"
	file_path := "./data/sociais/indigenas_pobreza_cadastro_unico.json"
	fileNameOutputCSV := "./data/sociais/indigenas_pobreza_cadastro_unico.csv"
