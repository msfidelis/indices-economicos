...
func RunnerIPCA() {
	...
	runnerName := "IPCA - Histórico"
	url := "https://servicodados.ibge.gov.br/api/v3/agregados/1737/periodos/-99999/variaveis/63%7C69%7C2265?localidades=N1%5Ball%5D"
	unidadeMedida := "%"
	fonte := "https://servicodados.ibge.gov.br"
	file_path := "./data/inflacao/ipca.json"
	fileNameOutputCSV := "./data/inflacao/ipca.csv"
