...
func RunnerIPCADetalhado12Meses() {
	runnerName := "IPCA - Detalhado 12 Meses"
	url_old := "https://servicodados.ibge.gov.br/api/v3/agregados/1419/periodos/-999999/variaveis/2265?localidades=N1[all]&classificacao=315[7169,7170,7445,7486,7558,7625,7660,7712,7766,7786]"
	url := "https://servicodados.ibge.gov.br/api/v3/agregados/7060/periodos/-99999/variaveis/2265?localidades=N1[all]&classificacao=315[7169,7170,7445,7486,7558,7625,7660,7712,7766,7786]"
	unidadeMedida := "%"
	fonte := "https://servicodados.ibge.gov.br"
	file_path := "./data/inflacao/ipca_detalhado_12_meses.json"
	fileNameOutputCSV := "./data/inflacao/ipca_detalhado_12_meses.csv"
