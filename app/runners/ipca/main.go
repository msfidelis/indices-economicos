...
func Runner() {
	...
	url := "https://informederendimentos.com/indice-de-preco/ipca/"
	file_path := "./data/ipca/ipca.json"
	fileNameOutputCSV := "./data/ipca/ipca.csv"
	...
	c.OnHTML("table", func(e *colly.HTMLElement) {
		...
		e.ForEach("tr", func(i int, tr *colly.HTMLElement) {
			...
			if i == 0 {
				...
				ipca.Data = append(ipca.Data, item)
