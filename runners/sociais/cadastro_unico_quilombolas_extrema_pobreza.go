...
func RunnerCadastroUnicoQuilombolasExtremaPobreza() {

	runnerName := "Quilombolas Pobreza"
	domain := "aplicacoes.cidadania.gov.br"
	url := "https://aplicacoes.cidadania.gov.br/vis/data3/v.php?q%5B%5D=oNOclsLerpibuKep3bV%2Bfmdm05Kv2rmg2a19ZW51ZXKmaX6JaV2Jk2CadmCNrMmTdKemr%2BKlrLGYkbaYY6WjlMnusm%2BiqaGt3nSItJiZysZupbCoyveTlakL4qbimsBuiKLAzaLXn6LJ3MBUobVVreKtwq%2F61BoEooqhmH3gxaiuraKbmam8sKmS0cJT06umwO22qJ27VajoWZCvm47K1aXZXfb36baXq8SldQ%3D%3D"
	unidadeMedida := "Familias Quilombolas em Situação de Extrema Pobreza"
	fonte := "https://aplicacoes.cidadania.gov.br"
	file_path := "./data/sociais/quilombolas_extrema_pobreza_cadastro_unico.json"
	fileNameOutputCSV := "./data/sociais/quilombolas_extrema_pobreza_cadastro_unico.csv"
