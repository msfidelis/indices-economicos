...
func RunnerCadastroUnicoCiganosExtremaPobreza() {

	runnerName := "Ciganos Extrema Pobreza"
	domain := "aplicacoes.cidadania.gov.br"
	url := "https://aplicacoes.cidadania.gov.br/vis/data3/v.php?q%5B%5D=oNOclsLerpibuKep3bV%2Bfmlm05Kv2rmg2a19ZW51ZXKmaX6JaV2Jk2CadmCNrMmTbX%2BUoNqmrLGglLbElM6cao22s5Wou5p135q5wZxokseU1rCYmLbAqanEe5vm%2FPq6oI7KgXbTpJTL3MBUobVVreKtwq%2F61BoEooqhmH3gxaiuraKbmam8sKmS0cJT06umwO22qJ27VajoWZCvm47K1aXZXfb36baXq8SldQ%3D%3D"
	unidadeMedida := "Familias Ciganas em Situação de Extrema Pobreza"
	fonte := "https://aplicacoes.cidadania.gov.br"
	file_path := "./data/sociais/ciganos_extrema_pobreza_cadastro_unico.json"
	fileNameOutputCSV := "./data/sociais/ciganos_extrema_pobreza_cadastro_unico.csv"
