...
func RunnerCadastroUnicoPobreza() {

	runnerName := "Pobreza"
	domain := "aplicacoes.cidadania.gov.br"
	url := "https://aplicacoes.cidadania.gov.br/vis/data3/v.php?q[]=oNOclsLerpibuKep3bV%2Bf2xe05Kv2rmg2a19ZW51ZXKmaX6JaV2Jk2CadmCNrMmim7iareyYfYVnjIiVY8mglMG2s5Wou5p135q5wZxokseU1rCYmLbAqanEhZ%2FsrLyvqk28zlPdpqfS3BDb%2F%2BukWt2ebb6mj8nGrctdnMvusKalvJatmae8bnqOu8Km3q%2BifT7noqWrpLbpdA%3D%3D"
	unidadeMedida := "Pessoas em Situação de Pobreza e Extrema Pobreza no Cadastro Unico"
	fonte := "https://aplicacoes.cidadania.gov.br"
	file_path := "./data/sociais/pobreza_cadastro_unico.json"
	fileNameOutputCSV := "./data/sociais/pobreza_cadastro_unico.csv"
