...
func RunnerCadastroUnicoExtremaPobreza() {

	runnerName := "Extrema Pobreza"
	domain := "aplicacoes.cidadania.gov.br"
	url := "https://aplicacoes.cidadania.gov.br/vis/data3/v.php?q[]=oNOclsLerpibuKep3bV%2Bf2xf05Kv2rmg2a19ZW51ZXKmaX6JaV2Jk2CadmCNrMmim7iareyYfYVnjLrCl6WjlMnusm%2BiqaGt3nSItJiZysZupbCoyvedma%2B7pJvsWbK7V6DA1ajLANogHrxUoK1Vn%2FGtv7OkjnfRosyvmNfcbZ2qu5is4q2uwVebxoF2y6GU0O%2B%2Fo1wLz6jinLzKp2g%3D"
	unidadeMedida := "Pessoas em Situação de Pobreza e Extrema Pobreza no Cadastro Unico"
	fonte := "https://aplicacoes.cidadania.gov.br"
	file_path := "./data/sociais/extrema_pobreza_cadastro_unico.json"
	fileNameOutputCSV := "./data/sociais/extrema_pobreza_cadastro_unico.csv"
